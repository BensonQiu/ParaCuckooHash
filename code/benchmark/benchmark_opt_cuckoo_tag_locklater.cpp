...
template <typename T>
void BenchmarkOptCuckooTagLockLaterHashMap<T>::benchmark_random_interleaved_read_write() {
...
template <typename T>
void BenchmarkOptCuckooTagLockLaterHashMap<T>::benchmark_read_only() {

    OptimisticCuckooTagLockLaterHashMap<T> my_map(m_num_buckets);
...
template <typename T>
void BenchmarkOptCuckooTagLockLaterHashMap<T>::benchmark_read_only_single_bucket() {
...
template <typename T>
void BenchmarkOptCuckooTagLockLaterHashMap<T>::benchmark_space_efficiency() {
